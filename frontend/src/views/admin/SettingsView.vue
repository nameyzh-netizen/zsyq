              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "智算引擎") +
                        " 100 " +
                ...
                <!-- Row 4: Enabled payment types (provider badges like zsyqpay) -->
                <div>
                  <label class="input-label">{{
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/nameyzh-netizen/zsyq/blob/main/docs/支付系统配置指南.md"
    : "https://github.com/nameyzh-netizen/zsyq/blob/main/docs/支付系统配置指南_EN.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/nameyzh-netizen/zsyq/blob/main/docs/支付系统配置指南.md#支持的支付方式"
    : "https://github.com/nameyzh-netizen/zsyq/blob/main/docs/支付系统配置指南_EN.md#supported-payment-methods",
);
