...
const { t } = useI18n()
const LOGIN_AGREEMENT_STORAGE_KEY = 'zsyq_login_agreement_consent'
...
function sanitizeRedirectPath(path: string | undefined): string | null {
...
async function handleLogin(): Promise<void> {
  ...
  try {
    ...
    const redirectTo = sanitizeRedirectPath(router.currentRoute.value.query.redirect as string) || '/dashboard'
