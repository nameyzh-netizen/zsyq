...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["zsyq-admin", "jwt.<token>"].
	// - We always select "zsyq-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"zsyq-admin"},
}
