...
import (
	...
	"github.com/nameyzh-netizen/zsyq/ent/paymentorder"
	"github.com/nameyzh-netizen/zsyq/internal/payment"
	"github.com/nameyzh-netizen/zsyq/internal/payment/provider"
...
func (s *PaymentService) buildPaymentSubject(plan *dbent.SubscriptionPlan, limitAmount float64, cfg *PaymentConfig, sel *payment.InstanceSelection) string {
	if plan != nil {
		...
		return "智算引擎 Subscription " + plan.Name
	}
	...
	return "智算引擎 " + amountStr + " " + currency
}
