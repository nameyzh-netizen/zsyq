#!/bin/bash
# =============================================================================
# 智算引擎 Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for 智算引擎:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/nameyzh-netizen/zsyq/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  智算引擎 Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    echo ""
    print_info "ADMIN_PASSWORD is required for AUTO_SETUP. Set it in .env before starting services."
    echo ""
}
