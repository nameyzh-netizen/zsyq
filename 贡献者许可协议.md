# 智算引擎 Individual Contributor License Agreement (v1.0)

Thank you for your interest in contributing to 智算引擎 ("the Project"). This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Project.
...
- **"Project Owner"** means nameyzh-netizen, or any individual or legal entity to whom nameyzh-netizen has explicitly assigned or transferred ownership of the Project in writing, and their respective successors and assigns.
